...
class TabletChangePasswordScreen extends StatefulWidget {
  const TabletChangePasswordScreen({super.key});

  @override
  State<TabletChangePasswordScreen> createState() =>
      _TabletChangePasswordScreenState();
}

class _TabletChangePasswordScreenState
    extends State<TabletChangePasswordScreen> {
