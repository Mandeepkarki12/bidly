...
class DesktopShimmer extends StatelessWidget {
  final double width;
  const DesktopShimmer({super.key, required this.width});
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                shimmerBox(height: 450, width: width * 0.4, radius: 10),
            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return shimmerBox(
                      height: 300, width: width * 0.23, radius: 12);
                },
              ),
            ),
          ],
